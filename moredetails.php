...
$pid=$_POST['pid'];
$uid=$_SESSION["userid"];
$qry="insert into book (userid,pid,status) values('$uid','$pid','1')";
$result=mysqli_query($con,$qry) or die(mysqli_error($con));
$q=mysqli_query($con,"update properties set status='1' where pid=$pid");
...
?>
<div style="border:0">
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="<?php echo $row['img']?>" width="600px" height="400px" style="border:3px solid #006600; border-radius:30px;">
<p>&nbsp;</p>
