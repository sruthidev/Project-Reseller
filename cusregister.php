...
$l=$_POST["password"];
 ...
 $sql2="INSERT INTO `customer`(`first_name`, `last_name`, `mobile_number`, `email`, `Password`, `status`) VALUES ('$a','$b','$d','$e','$l',1)";
		...
		<div id="wrapper" class="container">
            ...
            ?>
									...
									<div class="controls">
                                                                            ...
                                                                            <select class="form-control" name="state_select" id="state_select"><option value="-1">select</option></select>
									</div>
								</div><div class="control-group">
