...
$sql1="INSERT INTO `login`(`username`, `password`,`role_id`) VALUES ('$k','$l','2')";
...
$sql="INSERT INTO `seller`( `first_name`, `last_name`, `store_name`, `mobile_number`, `email`, `gst_no`, `username`, `password`, `status`) VALUES ('$a','$b','$c','$d','$e','$f','$k','$l',1)";
					...
					<div class="span12">					
							...
							<fieldset>
								...
								<div class="validation"></div>
									...
									<div class="controls">
                                                                            <input type="text" placeholder="Enter your country" id="country" name="country" class="input-xlarge" required/>
									</div>
								</div><div class="control-group">
